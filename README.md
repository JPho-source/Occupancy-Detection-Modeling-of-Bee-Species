...
year, month, and day record the date on which the bee was observed.
...
##### Violin_Plot.R
- Creates violin plots visualizing the distribution of model outputs, environmental variables, or trait metrics.
